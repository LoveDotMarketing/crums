...
export const locations: LocationData[] = [
  // Texas - Pickup Friendly (within ~100 miles)
  {
    ...
    stateAbbr: "TX",
    slug: "san-antonio-tx",
    metaTitle: "Trailer Rental San Antonio TX | 53' Dry Van Leasing | CRUMS Leasing",
    metaDescription: "Trailer rental & leasing in San Antonio, TX. Pick up at our Bulverde yard (30 min away) or get delivery. 53' dry van, flatbed & reefer trailers. Call 1-888-570-4564.",
  ...
  },
  {
    ...
    stateAbbr: "TX",
    slug: "austin-tx",
    metaTitle: "Trailer Rental Austin TX | Dry Van & Flatbed Leasing | CRUMS Leasing",
    metaDescription: "Commercial trailer rental in Austin, TX. Easy pickup from our Bulverde location (1 hour) or delivery available. Dry van, flatbed & refrigerated trailers.",
  ...
  },
  {
    ...
    metaTitle: "Trailer Rental New Braunfels TX | Local Pickup Available | CRUMS Leasing",
    metaDescription: "Trailer rental in New Braunfels, TX - just 20 minutes from our Bulverde headquarters. Pick up same-day or get delivery. Dry van & flatbed trailers available.",
  ...
  // Texas - Major Markets (Delivery)
  {
    ...
    stateAbbr: "TX",
    slug: "houston-tx",
    metaTitle: "Trailer Rental Houston TX | 53' Dry Van & Reefer Leasing | CRUMS Leasing",
    metaDescription: "Trailer rental & leasing in Houston, TX. We deliver to the greater Houston area. 53' dry van, flatbed & refrigerated trailers for the nation's largest trucking market.",
