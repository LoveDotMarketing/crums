...
const trailerData: TrailerProfileData = {
  ...
  features: [
    ...
    "Great Dane Champion CCC-3314-21053 composite plate construction",
    "Hendrickson ULTRAAK 40K air-ride suspension",
    "Hendrickson TIREMAAX CP tire inflation system",
    "Composite swing doors with EnduroGuard frame & rubber bumpers",
    "1.38\" hardwood laminated floor",
    "Energy Guard aerodynamic side skirts",
    "FleetPulseGo telematics tracking system",
    "Wabco 2S/1M iABS anti-lock braking system",
    "295/75R 22.5 Bridgestone Ecopia tires",
    "Jost A451 Magnum landing gear",
    "DOT compliant and road-ready",
    "LED exterior lighting package (Grote)",
